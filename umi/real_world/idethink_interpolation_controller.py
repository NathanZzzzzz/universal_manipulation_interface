...
from scripts_real.launch_idethink_interface_server import IdeThinkInterface
...
class IdeThinkInterpolationController(mp.Process):
    """
    ...
    def run(self):
        ...
        robot = IdeThinkInterface(self.robot_ip, self.robot_port)
